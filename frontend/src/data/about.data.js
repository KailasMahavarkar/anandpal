import ANAND_IMAGE from "../images/anand.jpg";
import PALLAVI_IMAGE from "../images/pallavi.jpg";

const PallaviInfo = () => {
	return (
		<>
			<span>
				Mrs. Pallavi is also a business entrepreneur as well as a
...
const AnandInfo = () => {
	return (
		<>
			<span>
				Mr. anand is a business entrepreneur. he helps people who have
