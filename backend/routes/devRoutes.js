...
// middlewares
const _nullCheckLogin = require("../middlewares/_nullCheckLogin")._nullCheckLogin;
const _nullCheckRegister = require("../middlewares/_nullCheckRegister")._nullCheckRegister;
const _sendMail = require("../middlewares/_sendMail")._sendMail;

const _authToken = require("../middlewares/_authToken")._authToken;
const _roleCheckMember = require("../middlewares/_roleCheckMember")._roleCheckMember
...
// CONTROLLERS
const deleteOverride = require("../controllers/Dev/deleteOverride").deleteOverride;
